...
$query = "SELECT id, product_id, product_name, product_price, user_id, date_added FROM sales_record WHERE user_id = ?";
    ...
    <div>
        ...
        <?php
            if ($result->num_rows > 0) { //If we can find users on the database
                ...
                $button_build_2 = ';">';
                echo "<table><tr><th>Sales ID</th><th>Product ID</th><th>Product name</th><th>Product price</th><th>User ID</th><th>Date added</th><th>Download</th></tr>";
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td>".$button_build_1."'php/download_img.php?id=".$row[0]."'".$button_build_2."</td></tr>";
                }
                echo "</table>";
            } else {
